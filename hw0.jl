...
student = (name = "Eduardo Ellery", kerberos_id = "eduellery")
...
ex_1_1 = md"""
Because the sqrt value is the value for which the divisor and quotient are equal (with zero remainder of course). Hence, if the divisor and quotient are different, the sqrt must be somewhere between then.
""" 
